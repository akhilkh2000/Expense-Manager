...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($conn, "insert into expenses(uidUsers,transDate,transType,transAmount,transCategory,transInfo) value('$userid','$dateexpense','D','$costitem','$category','$info')");
if($query){
