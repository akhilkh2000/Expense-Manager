							...
							<form role="form" method="post" action="">
								...
								<div class="form-group">
									...
									<select class="form-control" name="category" required>
										<option <?php if ($category == 'income') {
													echo ("selected");
												} ?> value='income'>Income</option>
										<option <?php if ($category == 'award') {
													echo ("selected");
												} ?> value='award'>Awards</option>
										<option <?php if ($category == 'gift') {
													echo ("selected");
												} ?> value='gift'>Gifts</option>
										<option <?php if ($category == 'other') {
													echo ("selected");
