                            ...
                            <form role="form" method="post" action="">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="period" required>
                                        ...
                                        <option value="all" <?php if (strval($_POST['period']) == "all") echo 'selected'; ?>>All</option>
                                    </select>
                                </div>
                                ...
                                <tbody>
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        if ($period == 'week') {
                                            ...
                                            $debug = '<script>console.log(' . json_encode($past30daysExpenses, JSON_HEX_TAG) .
                                                ');</script>';
                                            echo $debug;
                                            ...
                                            //     ');</script>';
                                            // echo $debug;
                                            // $row = mysqli_fetch_array($expenseData);
                                            // echo $row;
                                            mysqli_data_seek($expenseData, 0); //r
                                            $expenseTable = $expenseData;
                                            //   $expenseTable = mysqli_query($conn, "select * from expenses where idUsers='$userid'");
                                        }
                                    }
                                    while ($row = mysqli_fetch_assoc($expenseTable)) { ?>
                                        <tr>
        ...
        window.onload = function() {
            ...
            var debitChart = new CanvasJS.Chart("debitChart", {
                ...
                data: [{
                    ...
                    dataPoints: [{
                            y: <?php echo $entertainmentAmount ?>,
                            label: "Entertainment"
                        },
                        {
                            y: <?php echo $educationAmount ?>,
                            label: "Education"
                        },
                        {
                            y: <?php echo $billsAmount ?>,
                            label: "Bills and Utilities"
                        },
                        {
                            y: <?php echo $foodAmount ?>,
                            label: "Food and Beverage"
                        },
                        {
                            y: <?php echo $healthAmount ?>,
                            label: "Health and fitness"
                        },
                        {
                            y: <?php echo $clothingAmount ?>,
                            label: "Clothing"
                        },
                        {
                            y: <?php echo $footwearAmount ?>,
                            label: "Footwear"
                        },
                        {
                            y: <?php echo $transportationAmount ?>,
                            label: "Transportation"
                        },
                        {
                            y: <?php echo $investmentAmount ?>,
                            label: "Investment"
                        }
                    ]
                }]
            ...
            var creditChart = new CanvasJS.Chart("creditChart", {
                ...
                data: [{
                    ...
                    toolTipContent: "<b>{label}:</b> {y} (#percent%)",
                    dataPoints: [{
                            y: <?php echo $incomeAmount ?>,
                            label: "Income"
                        },
                        {
                            y: <?php echo $awardAmount ?>,
                            label: "Award"
                        },
                        {
                            y: <?php echo $giftAmount ?>,
                            label: "Gifts"
                        },
                        {
                            y: <?php echo $otherAmount ?>,
                            label: "Other"
                        }
                    ]
                }]
